...
interface CartContextType {
  items: CartItem[];
  addItem: (product: Product, options?: { size?: string; color?: string; braiding?: string }) => void;
...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  const addItem = useCallback((product: Product, options?: { size?: string; color?: string; braiding?: string }) => {
    setItems(prev => {
