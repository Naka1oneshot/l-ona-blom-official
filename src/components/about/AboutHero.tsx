  ...
  >
    ...
    >
      <div className="bg-background/95 backdrop-blur-sm p-8 sm:p-12 md:p-16 text-center">
        ...
        <blockquote className="text-display text-2xl sm:text-3xl md:text-[40px] leading-tight tracking-tight mb-8 text-foreground">
          «&nbsp;{quote}&nbsp;»
        </blockquote>
        
        <div className="w-10 h-px bg-primary/40 mx-auto mb-6" />
        
        <p className="text-xs sm:text-sm tracking-[0.2em] uppercase font-body text-muted-foreground mb-10">
          {author}
        </p>
