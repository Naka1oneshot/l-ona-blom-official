      ...
      <section className="luxury-container luxury-section max-w-md mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-foreground/20 py-3.5 text-xs tracking-[0.15em] uppercase font-body hover:bg-muted/50 transition-colors duration-300 disabled:opacity-50"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-foreground/20 py-3.5 text-xs tracking-[0.15em] uppercase font-body hover:bg-muted/50 transition-colors duration-300 disabled:opacity-50 mt-3"
          >
